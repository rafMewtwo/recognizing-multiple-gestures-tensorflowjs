...
const myGesture = new GestureDescription('l'); // l


myGesture.addCurl(Finger.Index, FingerCurl.NoCurl, 1.0);
// myGesture.addCurl(Finger.Index, FingerDirection.VerticalUp, 1.0);
myGesture.addCurl(Finger.Thumb, FingerCurl.NoCurl, 1.0);
myGesture.addCurl(Finger.Middle, FingerCurl.FullCurl, 1.0);
myGesture.addCurl(Finger.Ring, FingerCurl.FullCurl, 1.0);
myGesture.addCurl(Finger.Pinky, FingerCurl.FullCurl, 1.0);
...
const gestures = [
  rockGesture, paperGesture, scissorsGesture, dontGesture, myGesture
]
